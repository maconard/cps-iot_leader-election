...
# Generates worker binaries for a range of parameters

# Note: T should be entered in seconds
# Note: will default to ranges K=(2,10,1) and T=(0.3,2.5,0.1)

# usage: ./generate workers <board> <min_K> <max_K> <step_K> <min_T> <max_T> <step_T>
...
echo "Beginning binary generation for ranges K=($MIN_K,$MAX_K,$STEP_K) and T=($MIN_T,$MAX_T,$STEP_T)..."
